import 'package:bara_flutter/fix/login.dart';
import 'package:bara_flutter/pages/login/login.dart';
import 'package:flutter/material.dart';

class StartsPage extends StatelessWidget {
  const StartsPage({Key? key}) : super(key: key);
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LoginsPage()), // Ganti LoginPage() dengan halaman login yang sebenarnya
                          );
                        },
                          style: ButtonStyle(
