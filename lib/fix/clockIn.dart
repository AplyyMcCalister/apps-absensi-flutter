...
class ClocksIns extends StatefulWidget {
  const ClocksIns({Key? key}) : super(key: key);

  @override
  _ClockInState createState() => _ClockInState();
}

class _ClockInState extends State<ClocksIns> {
  late AppConfig _ac;
                                ...
                                child: Container(
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: 'Muhammad Rafly Syah Alam',
                                      hintStyle: TextStyle(
                                        color: Colors.blue,
                                      ),
                                      filled: true,
